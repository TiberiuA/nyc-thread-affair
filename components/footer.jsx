...
<section className="footer-contact">
  <p>
  Largo Augusto 3, Milano, 20122, Milano,
  IT Tel: 0039 02 760 003 66 office@thread-affair.com
  </p>
</section>
      </div>
    </section>
    ...
    <section className="footer-secondary text-center">
      ...
      <p className="mb-2">2019 THREAD AFFIAR. All Rights Reserved.</p>

      <p className="d-flex align-items-center justify-content-center">
        Designed by
        <img src="/images/pixellab_logo.jpg"
        alt="Pixellab"
        className="ms-2">
        </img>
      </p>
